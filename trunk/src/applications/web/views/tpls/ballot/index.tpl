...
<style>
    ...
    * { -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}
    ...
    a:hover{text-decoration: none;}
        /*load*/
    .load{background:#35757b;height:100%;width:100%;position:absolute;z-index:30000;top:0;left:0}
    .load .icon{position:absolute;top:40%;left:50%;margin-top:-50px;margin-left:-50px;width:100px;height:100px;-webkit-animation:shun360 2s linear infinite;-moz-animation:shun360 2s linear infinite;-o-animation:shun360 2s linear infinite;animation:shun360 2s linear infinite
    }
    ...
    .load_num{position:absolute;width:100%;text-align:center;font-size:15px;top:50%;left:0;color:#f54444}
    .load_num{position:absolute;width:100%;text-align:center;font-size:15px;top:60%;left:0;color:#fff}
    .load_txt{position:absolute;width:100%;text-align:center;font-size:15px;top:50%;left:0;color:#fff}

        /*首屏背景图*/
    #layout_1.anim,#layout_2.anim{transition:top 0.5s linear; -webkit-transition:top 0.5s linear; -moz-transition:top 0.5s linear; -ms-transition:top 0.5s linear; -o-transition:top 0.5s linear;}
    #layout_1{top:0; width: 100%; height: 100%; position:absolute;}
    #layout_1.fadeOut{top:-100%;z-index:999}
    #layout_2.fadeIn{top:0;}


        /*箭头*/
    .swipeTip{ position:absolute; left:50%; bottom:3.05rem; width: .91rem; height: .73rem; margin-left: -.455rem; background:url(/resource/img/ballot/up.png) no-repeat;-webkit-background-size:100% 100%;background-size:100% 100%;z-index:999}
    .swipeTip{-webkit-animation:1s fadeOutUp ease-in-out infinite;-moz-animation:1s fadeOutUp ease-in-out infinite}
    @-webkit-keyframes fadeOutUp{
    0%{opacity:1;-webkit-transform:translateY(0px);transform:translateY(0px)}
    50%{opacity:0.3;-webkit-transform:translateY(-10px);transform:translateY(-10px)}
    }
    @keyframes fadeOutUp{
    0%{opacity:1;-webkit-transform:translateY(0);-ms-transform:translateY(0);transform:translateY(0)}
    50%{opacity:0.3;-webkit-transform:translateY(-10px);-ms-transform:translateY(-10px);transform:translateY(-10px)}
    }
    /*第一屏*/
    #layout_1 {background:url(/resource/img/ballot/bg1.jpg) no-repeat; background-size:7.5rem 13.34rem;background-position:0 -1.15rem;-webkit-overflow-scrolling:touch;}
    #layout_1 .logo,#layout_2 .logo {position: absolute; bottom: .75rem; width: 4.51rem; height: .47rem; left: 50%; margin-left: -2.255rem; }
    #layout_1 .logo img,#layout_2 .logo img{display:block;}
    #layout_1 img {width: 100%; height: 100%;}
    #layout_1 .title-container {position: absolute; top: 2.45rem; left: 50%; width: 5.15rem; height:3.17rem; margin-left: -2.57rem; }
    #layout_1 .button {position: absolute; bottom: 1.95rem; width: 2.62rem; height: 1.04rem; left: 50%; margin-left: -1.31rem;}
        /*第二屏*/
    #layout_2{top: 100%; width: 100%; height: 100%; position: absolute;background:url(/resource/img/ballot/bg2.jpg) no-repeat 0 0/100% 100%;overflow:hidden;}
    #layout_2 .content {position: absolute;top:3.47rem;height: 5.64rem; left: 50%; margin-left: -3.02rem;}
    #layout_2 .title-container {position: absolute; top: .60rem; left: 50%; width: 4.31rem; height: 2.45rem; margin-left: -2.155rem;}
    #layout_2 .container {width: 3.02rem; height: 2.82rem; float:left; background: rgba(35,50,37,0.4); padding: .45rem 0  0 .60rem; font-size: .24rem; color: #fff; position: relative;margin:.02rem}
    #layout_2 .top span {display:inline-block;padding-left:.24rem;background:url(/resource/img/ballot/icon.png) no-repeat;background-size:.16rem .21rem;background-position:0 .07rem}
    #layout_2 .center { font-size: .37rem; margin-top: .17rem; font-weight: bold;}
    #layout_2 .bottom {position: absolute; bottom: .50rem; font-size: .347rem;}
    #layout_2 .bottom img {width:.27rem; height: .32rem; display: inline-block; vertical-align: top;}
        /*主内容区域*/

        /*第三屏*/
    #layout_3 {width: 100%;height: 100%; position: absolute; top: 0; overflow: auto;display:none;-webkit-overflow-scrolling:touch; }
    #layout_3 img {width: 100%; height: 100%;display:block;}
    #layout_3 {background:url(/resource/img/ballot/bg2.jpg) no-repeat; background-size:100% 100%; }
    #layout_3 .title-container {width: 4.31rem; height: 3.05rem; margin: 0 auto; padding-top: .6rem;}
    #layout_3 .text {width: 5.26rem; height: .23rem; margin: .32rem auto 0;}
    #layout_3 .content {width: 5.28rem;margin: .24rem auto 0;}
    #layout_3 .content:after{content:".";display:block;height:0;clear:both;visibility:hidden;}
    #layout_3 .container {width: 2.52rem; height: 3.21rem; float: left; margin-bottom: .26rem; font-size: .24rem; color: #fff;}
    #layout_3 .container:nth-child(odd) {margin-right: .12rem;}
    #layout_3 .container:nth-child(even) {margin-left: .12rem;}
    #layout_3 .container .top {width: 100%; height: 2.15rem; position: relative;text-align:center;z-index:9}
    ...
    #layout_3 .make{width: 100%; height: 2.15rem;position:absolute;top:0;left:0;background:#000;opacity:0.5;z-index:10}
    ...
    #layout_4 .brief-success{width:1.87rem;height:1.15rem;overflow:hidden;}
    ...
    .mask i{width:119px;height:199px;background:url(http://y2.ifengimg.com/7573d3fe499db027/2015/0120/bg6.png) 0 0 no-repeat;background-size:119px 199px;display:block;margin:0 auto;-webkit-animation:maskAni 1.5s ease infinite alternate;animation:maskAni 1.5s ease infinite alternate}
